...
<head>
    ...
    <style>
        ...
        .more { font-size: 13px; color: #2563eb; }
        .grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(140px, 1fr)); gap: 12px; }
        .card { border-radius: 10px; overflow: hidden; background: #f9fafb; border: 1px solid #eef2f7; display: flex; flex-direction: column; }
        .card img { width: 100%; height: 120px; object-fit: cover; background: #e5e7eb; }
