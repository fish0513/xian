...
<div class="max-w-3xl mx-auto">
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                <?php echo $isEdit ? '修改子栏目配置' : '创建新的子栏目'; ?>
            </p>
        </div>
    ...
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
        <form method="post" action="<?php echo View::e($base); ?><?php echo $isEdit ? '/admin/food/categories/edit' : '/admin/food/categories/create'; ?>">
            ...
            <div class="px-4 py-6 sm:p-8">
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        <label for="code" class="block text-sm font-medium leading-6 text-gray-900">编码</label>
                        <div class="mt-2">
