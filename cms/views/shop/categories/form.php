...
<div class="max-w-2xl mx-auto">
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="<?php echo View::e($base); ?>/admin/shop/categories"
    ...
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
        <form method="post" action="<?php echo View::e($base); ?><?php echo $isEdit ? '/admin/shop/categories/edit' : '/admin/shop/categories/create'; ?>">
            ...
            <div class="px-4 py-6 sm:p-8">
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <p class="mt-1 text-xs text-gray-500">英文标识，如 shopping_complex，创建后不可修改</p>
                    </div>
